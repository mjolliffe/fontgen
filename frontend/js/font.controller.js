...
function FontController ($state, $stateParams, $scope, $http){
 ...
 // if randomize is clicked, randomize. if lock is clicked then header or paragraph should lock --- watch for randomize click and then block function when set is clicked
